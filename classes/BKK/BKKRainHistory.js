...
const nodeName = "BKKRainHistory";

let config = null;
let id = null;
class BKKRainHistory {
    
    constructor(id="RF.LKB.004",username=null,password=null) {
        let user = username;
        let pass = password;
        ...
        const baseURL = 'https://weather.bangkok.go.th/dds_webservices/api/rain/History?id=' + id;
