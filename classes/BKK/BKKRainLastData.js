...
const nodeName = "BKKRainLastData";

let config = null;
class BKKRainLastData {
    ...
    constructor(username=null,password=null) {
        ...
        const baseURL = 'https://weather.bangkok.go.th/dds_webservices/api/rain/lastdata';
...
export default BKKRainLastData