...
const nodeName = "TMDWeather3Hours";

let config = null;
let id = null;
class TMDWeather3Hours {
    constructor(uid=null,ukey=null) {
        if(!ukey)
            ukey = 'api12345';
        if(!uid)
            uid = 'api';
        const baseURL = 'https://data.tmd.go.th/api/Weather3Hours/V2/?uid=' + uid + '&ukey=' + ukey;
...
export default TMDWeather3Hours